/*
Deployment script for WhoCanHelpMeUsers
*/
...
GO
:setvar DatabaseName "WhoCanHelpMeUsers"
...
CREATE DATABASE [$(DatabaseName)]
    ON 
    PRIMARY(NAME = [WhoCanHelpMeUsers], FILENAME = '$(DefaultDataPath)$(DatabaseName).mdf', FILEGROWTH = 1024 KB)
    LOG ON (NAME = [WhoCanHelpMeUsers_log], FILENAME = '$(DefaultLogPath)$(DatabaseName)_log.ldf', MAXSIZE = 2097152 MB, FILEGROWTH = 10 %) COLLATE Latin1_General_CI_AS
GO
